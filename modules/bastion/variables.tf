...
variable "bastion_image" {
  description = " Image type you want to use for the bastion server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific."
  type        = string
}
